...
This theme supports rendering beautiful math in inline and display modes using [MathJax](https://www.mathjax.org/)<d-footnote>
  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. For example, MathJax happily renders $$ e^{i\pi} + 1 = 0 $$ inline inside a footnote.</p>
  <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. You can also include code: <code>\sum_{k=1}^n k = n(n+1)/2</code>.</p>
</d-footnote> 3 engine.
