...
My research interests lie primarily in model-based reinforcement learning and sim-to-real transfer. I am especially interested in *how an agent should act in order to improve its model of the world*. Previously, I approached this via model misspecification in Bayesian experimental design.
